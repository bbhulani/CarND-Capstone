...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        ...
        # ([x,y],1) returns the closest item to position [x,y]
        # [1] at the end returns the index of the closest item
        ...
        # If dot product is positive closest_coord is behind car's position
        # So take the next closest_idx
        if val > 0:
